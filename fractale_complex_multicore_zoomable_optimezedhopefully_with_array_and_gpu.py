...
class Game():
    ...
    @staticmethod
    @jit(nopython=True)
    def mandelbrot_gpu( x, y, x1, y1, l, h, MAX_ITERATION, XMAX, XMIN, YMAX, YMIN, LARGEUR, HAUTEUR):
    ...
    def compute_surface(self, x, y):
        ...
        for x1 in range(l):
            ...
            for y1 in range(h):
                ...
                n = self.mandelbrot_gpu(x, y, x1, y1, l, h, self.MAX_ITERATION, self.XMAX, self.XMIN, self.YMAX, self.YMIN, self.LARGEUR, self.HAUTEUR)
